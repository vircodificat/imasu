...
pub fn mmio_reg_read(dev: *Device, comptime T: type, reg_addr: u64) Exception!T {
...
pub fn mmio_reg_write(dev: *Device, comptime T: type, reg_addr: u64, v: T) Exception!void {
    return switch (dev.kind) {
